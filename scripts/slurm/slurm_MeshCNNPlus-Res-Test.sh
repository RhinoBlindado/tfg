...
# [CASTELLANO]
#
#    Prueba de MeshCNNPlus con diferentes resoluciones de entrada
...
# [ENGLISH]
#
#    MeshCNNPlus test for different input resolutions
#    Course: Bachelor's Thesis
#    Author: Valentino Lugli (Github: @RhinoBlindado)
#    2022

# Job name
#SBATCH --job-name=MC+RES
...
# Basic parameters
##################
trainPath=("./networks/MeshCNNPlus/development/train.py")
testPath=("./networks/MeshCNNPlus/development/test.py")
...
testName=("MeshCNNPlus-ResTest-50K")
...
testName=("MeshCNNPlus-ResTest-100K")
